...
export class AppComponent {
  ...
  ngOnInit(): void {
    ...
    this.dashboard = [
      { cols: 2, rows: 2, y: 0, x: 0, resizeEnabled: true, innerContent: `<img src="https://picsum.photos/seed/picsum/536/354" />` },
      { cols: 2, rows: 2, y: 3, x: 2, minItemRows: 2, minItemCols: 2, resizeEnabled: true, innerContent: `<img src="https://picsum.photos/seed/picsum/536/354" />` },
      { cols: 2, rows: 1, y: 5, x: 5 },
      { cols: 1, rows: 2, y: 0, x: 2, resizeEnabled: true, innerContent: this.card },
      { cols: 1, rows: 1, y: 0, x: 4 },
      { cols: 1, rows: 1, y: 2, x: 5 },
      { cols: 1, rows: 1, y: 1, x: 0 },
      { cols: 1, rows: 1, y: 1, x: 0 },
      { cols: 2, rows: 2, y: 2, x: 0, resizeEnabled: true, maxItemRows: 2, maxItemCols: 2, innerContent: this.table },
